      ...
      <!-- /.col-lg-3 -->
          ...
          <div class="col-lg-6 col-md-5 mb-4">
            <div class="card h-100">
              ...
              <div class="card-footer">
                <small><button type="button" value=1 class="btn btn-primary btn-lg btn-block" onClick="adicionar(this.value)" class="text-muted">Adicionar ao Carrinho</button></small>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-5 mb-4">
            <div class="card h-100">
              ...
              <div class="card-footer">
              	<small><button type="button" class="btn btn-primary btn-lg btn-block" onClick="Nova()" class="text-muted">Adicionar ao Carrinho</button></small>             
              </div>
            </div>
          </div>
